        ...
        var data1 = {
            ...
            datasets : [
                ...
                },
                {
                    label : "mq4", 
                    fill : true,
                    backgroundColor: "rgba(0, 255, 0, 0.2)", // Warna hijau muda untuk mq135
                    borderColor: "rgba(0, 255, 0, 1)",      
                    lineTension : 0.5,
                    pointRadius : 5,
                    data : [
                        <?php
                            mysqli_data_seek($supply_mq4, 0); // Mengembalikan pointer ke awal $supply_mq135
                            while($data_mq4 = mysqli_fetch_array($supply_mq4)) {
                                echo $data_mq4['ppm_mq4'].',' ;
                            }
                        ?>
                    ]
                }
