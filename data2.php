...
$tinggiair = mysqli_query($konek, "SELECT tinggiair from sensor WHERE ID>='$ID_awal' and ID<='$ID_akhir' ORDER BY ID ASC");
    ...
    <script type="text/javascript">
        ...
        var data2 = {
            ...
            datasets : [ 
            {
                ...
                data : [
                    <?php
                        while($data_tinggiair = mysqli_fetch_array($tinggiair))
                        {
                            echo $data_tinggiair['tinggiair'].',' ;
                        }
                    ?>
                ]
            }
