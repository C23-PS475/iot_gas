...
$(document).ready(function(){
        setInterval(function(){
            ...
            $("#ppText").load('ceksensor.php #ppm_mq4');
...
function updateUI(forced) {
    ...
    var ppTextValue = parseFloat($('#ppText').text());
    ...
    var ppMeterColor;
    if (ppTextValue >= 0 && ppTextValue <= 500) {
        ppMeterColor = ppColor;
    }else {
        ppMeterColor = progColor;
    }
    ...
    drawMeter(I("ppMeter"), ppTextValue, 500, meterBk, ppMeterColor);
                                ...
                                <div class="card-body ">
                                    <div class="testGroup">
                                        ...
                                        <div class="testArea">
                                            ...
                                            <canvas id="ppMeter" class="meter"></canvas>
                                            <div id="ppText" class="meterText"></div>
                                            <h4><div class="unit2">ppm</div></h4>
                                            <h5><div class="nilai">0</div></h5>
                                            <h5><div class= "nilai2">500</div><h5>
                                        </div>
                                        <div class="testArea">
                                            <div class="testName3">Jarak Alat</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-3">
                            <div class="card shadow mb-3">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h5 class="m-0 font-weight-bold" style="color: #8c5e58;">Grafik Jarak Alat Pada Permukaan Air</h5>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div id="grafik2">
