...
if (isset($_POST['filter'])) {
    ...
    $query = "SELECT ID, ppm_mq136, ppm_mq135, ppm_mq4, tinggiair, status, tanggal 
              FROM sensor 
                ...
                <div class="container-fluid">
                     ...
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold" style="color: #8c5e58;">Data Report</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form method="post">
                                    <table>
                                        <tr>
                                            ...
                                            <td><input type="submit" class="btn btn-primary" style="background-color:#8c5e58;"   name="filter" value="Filter"></td>
                                        </tr>
                                    </table>
                                </form>
                                <br>
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>PPM_mq135</th>
                                            <th>PPM_mq4</th>
                                            <th>Jarak Alat Pada Permukaan Air</th>
                                            <th>Status</th>
                                            <th>Waktu</th>
                                        </tr>
                                    </thead>
